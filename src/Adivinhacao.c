...
int main(){  
    ...
    do{
        ...
        srand(seed_segundos);    // srand() seed da função rand, seu parâmetro dever ser alguma fonte variável;
        ...
        for(int i =1 ;i <= num_de_tentativas;i++){
            ...
            // Se a divisão for entre variáveis ou constantes inteiras, o compilador irá truncar o resultado como inteiro, mesmo que a variável que recebe seu valor seja do tipo float ou double.
